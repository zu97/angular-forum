...
export const fetchCommentsFailure = createAction('[Comments] Fetch Failure', props<{ error: null | string }>());
...
export const addCommentsFailure = createAction('[Comments] Add Failure', props<{ error: null | string }>());
